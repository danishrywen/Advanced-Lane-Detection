...
def advanced_process_image(img):
    ...
    if(car_position > 0):
        cv2.putText(result,"Bike is: "+"{:.2f}".format(abs(car_position))+"m right of center",(20,150), font, 1.5,(255,255,255),2,cv2.LINE_AA)
    else:
        cv2.putText(result,"Bike is: "+"{:.2f}".format(abs(car_position))+"m left of center",(20,150), font, 1.5,(255,255,255),2,cv2.LINE_AA)
    if(locked):
...
cap = cv2.VideoCapture(r"C:\Users\danis\PycharmProjects\SET-1_w-CarND-Advanced-Lane-Lines-final working\project_video.mp4")
